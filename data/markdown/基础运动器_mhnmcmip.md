...
![](../images/c8476575-b0b9-4e19-a2ef-30a8a6b75d64.png)
...
*\*相对位置*：运行时无意义，在编辑时会预测该运动器单独生效时，经过生效时长后实体所在的位![](../images/c8476575-b0b9-4e19-a2ef-30a8a6b75d64.png) 2.匀速旋转运动器
...
*生效时长![](../images/8cb048a3-9a43-46c2-af59-cfd8f1689c91.png)在生效时长结束后会自动停止
...
描述让物体在指定时间内转向到指定角度的旋![](../images/b8ad3810-c5bd-4879-a777-e465a5c77acf.png)
...
* *单程*：到达路径终点后停止运动，关闭运动器
* *往返*：每当到达路径终![](../images/63ce1d88-b671-4898-a7c3-f7266b2553c0.png)动回起点
* *循环*：每当到达路径终点后瞬移到路径起点并重新开始路径
...
*![](../images/1c16f2e3-a48d-44e4-b87e-41b85b91e4af.png)：直接配置指定速率
...
* *未激活***：**默认配置在组件上的基础运动器，初始未生效时的状态。
* *运作中***：**基础运动器正常生效时的状态。
* *暂停中***：**基础运动器被暂停时的状态，区别于停止，暂停中的运动器会记录当前的运动进度，并在恢复后继续运动。
