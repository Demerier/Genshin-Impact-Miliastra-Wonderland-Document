...
![](https://act-webstatic.mihoyo.com/ugc-tutorial/knowledge/cn/zh-cn/mho2hirgodxi/f839553d-a80a-426e-bd26-1f23eb725ae7.png)
...
![]()![](../images/edc28eec-492d-44dd-9824-82a1137215f8.png)b5-b45b-455b-a58c-e74f35cf0cc3.png)负载计算区域，均匀的分布于整个场景中，因此对于不同高度的情况，都会有对应的区域进行计算。
...
![](../images/72![](../images/b5a8a2f4-9ee7-4235-b0a3-5342139559e2.png)4-875e-4c4a-bc88-3b331cfa4cd6.png)eaf0362.png)c1.png)白色  代表计算静态负载，小于推荐值 |  |
| *\*计算静态负载* | 当前朝向的**计算静态负载**/推荐上限值  首先区域会计算以点位为中心，在指定朝向，且处于可见视距范围内的实体的负载  其次，根据实体和中心点的距离，会对实体以距离系数进行二次计算，最终实体的负载之和为计算静态负载  如下图，同样的八个史莱姆，根据距离中心点距离的![](../images/678e2b76-![](../images/f084e31c-0dc9-4ffc-b23b-458e2bc3f683.png)值也有不同计算结果，距离越远，负载越小。    而下图中，红色区域包含16个史莱姆，蓝色区域仅包含8个史莱姆，即便距离远距离系数小，红色区域依然会因为包含更多的实体而承担更多的计算负载。 | |
| *\*内存静态负载* | ![](../images/6890f3cc-4a44-4a0d-bed1-b368bb6e1bdb.png)**内存静态负载** | |

# 五、动态负载计算

在关卡运行时，通过节点图创生的实体和特效等，会对运行的负载造成影响，这部分无法通过静态计算预估。因![](../images/93d795be-1104-4bab-b7fc-57c39![](../images/b1b438b0-![](../images/a318d70a-![](../![](../images/4f5561d2-e736-4bcb-bcca-1297eccbf0ac.png)4cfb-8502-c140c074c730.png)cb.png)态负载计算功能，便于创作者(奇匠)获取关卡运行的负载数据，进行调整。
