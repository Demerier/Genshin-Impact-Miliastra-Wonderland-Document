...
![](../images/afefa858-f9d6-463b-8e4e-e9aaaded0db1.png)

![](../images/8c5894ae-afbc-43ab-bcec-227a03df6882.png)

在对局结束进行结算时，玩家的段位积分会有相应的累计

![](../images/30ed0806a04f93661a9006d69c02dc55_1![](../images/afefa858-f9d6-463b-8e4e-e9aaaded0db1.png)

# 二、计分组的编辑

从系统菜单点击【外围系统管理】，可进入外围![](../images/8c5894ae-afbc-43ab-bcec-227a03df6882.png)面

![](https://act-webstatic.mihoyo.com/ugc-tutorial/knowledge/cn/zh-cn/mhf45sisuup8/afefa858-f9d6-463b-8e4e-e9aaaded0db1.png)

在外围系统设置界面的竞技段位页签，即可进行竞技段位相关的设置

段位分的修改通过计分组模板的形式进行预设，对局内的每一个玩家应用一份![](../images/82e7245f-b661-43d5-9d53-26ed2cfab182.png)，点击右下角的“新建计分组”按钮，即可新增一个计分组模板
...
玩家逃跑可能是由于多种情况导致的，例如队友大量逃跑或挂机、由于网络原因掉线超时、对局在后半期双方实力过于不平衡导致对局不再有可玩性，创作者(奇匠)可以按照关卡的实际情况，对玩家的逃跑![](../images/eefd8b3![](../images/93021a7![](../images/a67c8![](../images/3118eac6-595f-4a05-b32d-2dd0aded543f.png)b-4b12-9d58-df7e7bacd911.png)外处理
