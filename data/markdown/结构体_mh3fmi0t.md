...
![](../images/e5db55a4-ab6b-484f-a6b6-c0e83b4b8418.png)
...
创作者(奇匠)还可以结合*字典*等数据结构，在自定义变量![](../images/e5db55a4-ab6b-484f-a6b6-c0e83b4b8418.png)相关的全量数据
...
与列表相似，结构体在节点图中也是以引用的方式进行传递的。因此结构体相关的修改节点会直接作用于自定义变量、节点图变量内的结构体数据，具体见[自定义变量](/ys/ugc/tutorial//detail/mhs![](../images/d505f809-0028-4f5e-ae75-709b171103c6.png)jica)

同理，*自定义变量变化时*事件中不会传出![](../images/0113515f-c41d-412f-bcde-d4cc8c511bc0.png)值*】和【*变化后值*】字段，需要使用*获取自定义变量*来获取变化后的值
