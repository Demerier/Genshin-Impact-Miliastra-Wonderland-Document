...
![](../images/06e7bbf8-b1cb-471d-9862-1e46555ba33e.png)
...
*商店名称*：创作者(奇匠)编辑时定义的商店名![](../images/06e7bbf8-b1cb-471d-9862-1e46555ba33e.png)无意义
...
*自身背![](../images/6f878479-962e-4876-979e-fe34164aeb43.png)售的虚拟物品都来自于商店持有者的背包，只可重新定义每类道具的售价，不允许出售背包内没有的虚拟物品

*\*出售范围*：分为全部道具和部分道具，其决定了出售设置表初始化时，是否会默认添加创作者(奇匠)定义的全部的道具

*自定义列表*：可以自由定义出售商品类型和数量，其作为一个数据模板存在，并不会对商店持有者的背包数据产生影响

*![](../images/0bd02cb5-392c-42e8-8a9d-2f80755e7759.png)：定义该商店模板的出售价格表
...
*排序优先级*：定义了商品在商店界面内的排序，优先级越高的商品![](../images/ae3a9f6f-7a41-4df7-8eec-802cea72207b.png)*是否可售*：为"是"该道具才会出现在交易界面内，可在运行时动态修改以达到解禁新商品的效果

*售价*：在进行交易行为时，买方购买一个该道具需要的货币量

为自定义商品时，![](../images/cd32dbb6-7675-44b7-a5b0-0722d18b7a04.png)图所示：
...
*是否限量*：若为“否”，则可以无限购买。若为“是”![](../images/56735c84-d6cb-464d-8aec-a0c611a19db2.png)义该商店内总共可出售的该道具数量
...
在游戏运行时，商店模板被[商店组件](./商店组件_mho6gviq.md)引用并实例化
