...
![](../images/节点图变量_mhtshailzs7w_1节点图变量页签入口.png)

## 2.新建节点图变量

页签操作与[自定义变量](自定义变量_mhso1b9wjica.md)类似，可以新增、修改已配置的节点图变量

![](../images/节点图变量_mhtshailzs7w_2新建节点图变量.png)

## 3.在节点图中使用节点图变量

在节点图中，可以使用以下节点图相关节点（与自定义变量相关节点用法基本一致）

![](../images/节点图变量_mhtshailzs7w_3在节点图中使用节点图变量.png)![](../images/节点图变量_mhtshailzs7w_3在节点图中使用节点图变量_2.png)![](../images/节点图变量_mhtshailzs7w_3在节点图中使用节点图变量_3.png)

此外，可以通过拖拽节点图变量中的变量到编辑区域来创建节点图变量的操作节点

![](../images/节点图变量_mhtshailzs7w_3在节点图中使用节点图变量_4.png)

松开后，会显示快捷创建选单，允许选择设置和获取该节点图变量

![](../images/节点图变量_mhtshailzs7w_3在节点图中使用节点图变量_5.png)

选择后，会快速新建一个节点图变量的设置或获取节点

![](../images/节点图变量_mhtshailzs7w_3在节点图中使用节点图变量_6.png)
...
![](../images/节点图变量_mhtshailzs7w_4向关卡暴露节点图变量.png)

在关卡的节点图上，可以看到目前已对外暴露的节点图变量数。

![](../images/节点图变量_mhtshailzs7w_4向关卡暴露节点图变量_2.png)

点击编辑变量数，即可编辑该节点图变量在该实体上的覆写值

![](../images/节点图变量_mhtshailzs7w_4向关卡暴露节点图变量_3.png)
