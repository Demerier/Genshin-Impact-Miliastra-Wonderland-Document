...
点击【新建技能】![](../images/67197b0b-2c76-4068-8c4e-ac7d82120814.png)04f93661a9006d69c02dc55_1818194431287328309.png)

![](https://act-webstatic.mihoyo.com/ugc-tutorial/knowledge/cn/zh-cn/mho81frl33im/eb78b6fd-7470-4cf1-94ca-ba238c081fc1.png)
...
*使用次数*：技能添加时的默认可使用次数，当使用次数归0时，技能无法使用，每![](../images/d8cf8d23-1dff-478a-b72a-3acba248c95e.png)却时间，![](../images/df46894b![](../images/5410a844-e95a-4f5f-8da6-6c298ebda53e.png)次使用次数，最大恢复到默认配置的次数，就不会再增加
...
*长按*：长按技能进入瞄准状态，松开后退出![](../images/7df8deaa-0472-44aa-abc5-e6fb4dd9b3a4.png)切换*：点按技能![](../images/6e00![](../images/976d7e53-7c6a-4168-856d-07aef4392181.png)态，再次点击退出
...
在定义完了技能的释放条件和释放逻辑后，即可点击动画编辑，来继![](../images/e7087cf5-ff3c-4052-ac8f-f2c533e41d4c.png)不同的技能类型，配置方式也会有所区别：
...
动画是整个*技能轨道*的尺度，事件轴的总长度等于所有动画的时长之和，![](../images/f7cfd76b-8b![](../images/c43ae8b7-d1ca-4a2b-9dba-3712ca4b180e.png)画时点添加事件，即可让表现和逻辑匹配
...
*响应*：支持由创作者(奇匠)配置分支轨道![](../images/ad360![](../images/943695![](../images/ba14e8a8-![](../images/9078bc73-83c6-4222-a1de-8adde21591d1.png)7b7-4acf-b041-c4db59589a2b.png)落跳转到哪一个具体分支上

在分支轨道上，创作者(奇匠)可以通过调节每个段落的长度，来精细化调节分支转入的条件。在实际的运行时，当玩家停止长按时，当前的动画进度落在哪一个响应段落内，则动画会自动转入该段落所对应配置的分支

## 4.连段技能

*连段技能*支持创作者(奇匠)![](../![](../![](../images/9c4a9a![](../images/a02ed379-228b-44c6-ac2a-805b3318800d.png)s/639fd35a-ce4e-4701-adaf-384b85eb5a66.png)立的动作，并通过定义动作间的跳转规则和输入窗口期，来实现“连招”的效果。与此同时连段技能也提供了转入蓄力分支的功能，在配置上有两个页签：连段技能动画页签及蓄力分支动画页签
