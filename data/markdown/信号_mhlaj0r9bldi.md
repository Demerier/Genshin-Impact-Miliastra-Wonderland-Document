...
![](../images/信号_mhlaj0r9bldi_二信号的功能.png)

大门接收【机关触发信号】的信号，然后修改自身的预设状态（大门打开）

![](../images/信号_mhlaj0r9bldi_二信号的功能_2.png)

火把接收【机关触发信号】的信号，然后播放火焰特效

![](../images/信号_mhlaj0r9bldi_二信号的功能_3.png)

角色接收【机关触发信号】的信号，为自身添加一个技能

![](../images/信号_mhlaj0r9bldi_二信号的功能_4.png)

此时如果需要新增【修改丘丘人上的自定义变量】的逻辑，可以直接在丘丘人的节点图上：

![](../images/信号_mhlaj0r9bldi_二信号的功能_5.png)
...
![](../images/信号_mhlaj0r9bldi_三信号的配置.png)

可以打开信号管理器界面，在这个界面可以新增、修改信号

![](../images/信号_mhlaj0r9bldi_三信号的配置_2.png)
...
![](../images/信号_mhlaj0r9bldi_四信号的使用.png)

在节点图中放置了发送信号节点后，需要先选择【信号名】

![](../images/信号_mhlaj0r9bldi_四信号的使用_2.png)

选择【信号名】后，该节点的入参会新增这个信号名对应的信号的所有参数，可以将值传入信号中，并在接收信号端接收这一组参数

![](../images/信号_mhlaj0r9bldi_四信号的使用_3.png)

**向服务器节点图发送信号（客户端节点图）**

在技能节点图中，也可以使用定义好的信号向服务器节点图发送。所有服务器节点图都可以监听到该信号

![](../images/信号_mhlaj0r9bldi_四信号的使用_4.png)

**监听信号**

![](../images/信号_mhlaj0r9bldi_四信号的使用_5.png)

可以在任意的实体上接收信号，同样需要先选择【信号名】

![](../images/信号_mhlaj0r9bldi_四信号的使用_6.png)

选择【信号名】后，该节点的出参会新增这个信号名对应信号的所有参数，可以从这些出参取到由【发送信号】节点传入的参数值

![](../images/信号_mhlaj0r9bldi_四信号的使用_7.png)
