...
![](../images/复合节点_mhty17iqeht0_1节点图中的功能复用.png)
...
![](../images/复合节点_mhty17iqeht0_2复合节点的定义.png)
...
![](../images/复合节点_mhty17iqeht0_1复合节点的创建.png)

在任意框选的节点上点击右键菜单中的【生成复合节点】

![](../images/复合节点_mhty17iqeht0_1复合节点的创建_2.png)

即可创建一个新的复合节点

![](../images/复合节点_mhty17iqeht0_1复合节点的创建_3.png)

* **通过节点管理器创建**

从左上角窗口菜单中，打开节点管理器界面

![](../images/复合节点_mhty17iqeht0_1复合节点的创建_4.png)

在左侧复合节点分页中，可以新增复合节点页签

![](../images/复合节点_mhty17iqeht0_1复合节点的创建_5.png)

在复合节点管理页面中，点击右键-创建复合节点，即可创建一个新的复合节点

![](../images/复合节点_mhty17iqeht0_1复合节点的创建_6.png)
...
![](../images/复合节点_mhty17iqeht0_2复合节点编辑.png)
...
![](../images/复合节点_mhty17iqeht0_2复合节点编辑_2.png)

在引脚上点击右键，可以选择将该引脚作为复合节点引脚对外暴露

![](../images/复合节点_mhty17iqeht0_2复合节点编辑_3.png)
...
![](../images/复合节点_mhty17iqeht0_2复合节点编辑_4.png)

* **引脚详情编辑**

![](../images/复合节点_mhty17iqeht0_2复合节点编辑_5.png)
...
![](../images/复合节点_mhty17iqeht0_2复合节点编辑_6.png)

* **引脚合并**

当复合节点上存在两个类型相同的引脚时，可以将他们合并

![](../images/复合节点_mhty17iqeht0_2复合节点编辑_7.png)![](../images/复合节点_mhty17iqeht0_2复合节点编辑_8.png)![](../images/复合节点_mhty17iqeht0_2复合节点编辑_9.png)

合并后的引脚相当于同时连接在两个引脚上

如下图所示，1号和4号虚拟引脚分别连接在【设置自定义变量】和【获取自定义变量】的第一个入参引脚上

![](../images/复合节点_mhty17iqeht0_2复合节点编辑_10.png)

合并后，复合节点的样式如下图所示

![](../images/复合节点_mhty17iqeht0_2复合节点编辑_11.png)

可以看到复合节点的【目标实体】引脚现在同时连接在了【设置自定义变量】和【获取自定义变量】的第一个入参引脚上

![](../images/复合节点_mhty17iqeht0_2复合节点编辑_12.png)

## 3.在外部节点图中使用复合节点

外部节点图中，可以在【复合节点】分类中找到已经制作的复合节点

![](../images/复合节点_mhty17iqeht0_3在外部节点图中使用复合节点.png)

节点图中的复合节点与其他节点的规则完全一致，可以将其当作任意一种节点类型使用。如下图所示，这两张图的功能是完全相同的

![](../images/复合节点_mhty17iqeht0_3在外部节点图中使用复合节点_2.png)

![](../images/复合节点_mhty17iqeht0_3在外部节点图中使用复合节点_3.png)
