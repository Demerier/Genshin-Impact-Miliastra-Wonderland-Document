...
![](../images/泛型引脚_mhkirfrna1fy_一泛型引脚是什么.png)
...
![](../images/泛型引脚_mhkirfrna1fy_一泛型引脚是什么_2.png)
...
![](../images/泛型引脚_mhkirfrna1fy_一泛型引脚是什么_3.png)

通过连线、或手动确定泛型后，将该节点确定为特定类型的加法运算节点后（下图确定为了整数类型的加法运算），该节点才变为一个合法的可用节点

![](../images/泛型引脚_mhkirfrna1fy_一泛型引脚是什么_4.png)
...
![](../images/泛型引脚_mhkirfrna1fy_1手动确定泛型类型.png)
...
![](../images/泛型引脚_mhkirfrna1fy_2连线确定泛型类型.png)

泛型引脚同样可以连向泛型引脚。此时会使两个引脚都会被确定为一个默认的参数类型

以下图两个加法运算相连为例，两者会被确定为整数类型

![](../images/泛型引脚_mhkirfrna1fy_2连线确定泛型类型_2.png)
...
![](../images/泛型引脚_mhkirfrna1fy_2检查事件节点的泛型引脚.png)
