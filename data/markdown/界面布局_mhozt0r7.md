...
![](../images/92779ffe-1a5e-4282-a147-25547bd530e0.png)818194431287328309.png)
...
| --- | --- |
| 配置参数 | 说明 |
| *目标玩家* | 需要切换界面布局的玩家实体![](../images/0a58f49b-2![](../images/8d1828f2-915e-401c-9714-da19bfdb0e36.png)*布局索引* | 界面布局管理工具中，指定布局的索引 |
...
不同设备在1![](../images/622c7975-7072-4025-9233-6128d37022a1.png)ng)率下的主界面样式：
...
| --- | --- |
| 深色![](../images/42226a2b-c323-434e-88c1-540973fcda1a.png)5.png)e04712.png))主界![](../images/03b61fbb-de5c-4ade-8521-757855447900.png) |
| 标题/次要文字 | #D3BC8E |
| 普通文字 | #FFFFFF |
| 关键字1 | #FFCC33 |
| 关键字2 | #37FFFF |
